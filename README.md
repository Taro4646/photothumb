...
- **デザイン提案** — 出力比率のまま写真を 48px 幅にサンプリングし、7 つの領域それぞれの明るさと情報量を計測。
  最も静かな領域・最も暗い領域・左右の縦帯を比較して、書体だけでなく「どこに何を置くか」まで決めた案を 3 つ出す。
  各案には計測値にもとづく根拠が付き、ワンタップで配置・書体・色・沈め具合・フレームまで一括適用される
